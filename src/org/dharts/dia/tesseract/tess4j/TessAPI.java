...
/**
 * A Java wrapper for <code>Tesseract OCR 3.02 DLL</code> using <code>JNA Interface Mapping</code>.
 */
public interface TessAPI extends Library {
     ...
     */
    public static final TessAPI INSTANCE = (TessAPI) Native.loadLibrary(LIB_NAME, TessAPI.class);
     ...
     * <code>tessedit_ocr_engine_mode</code>.<br /> <br /> 
     * 
     * ATTENTION: When
     ...
     */
    void TessBaseAPIPrintVariables(TessAPI.TessBaseAPI handle, String filename);
     ...
     * <code>SetImage</code> and <code>AnalysePage</code>. Calls that attempt recognition 
     ...
     * advanced uses, use <code>SetImage</code>, optionally followed by 
     * <code>SetRectangle</code>, along with <code>Recognize</code> and one or more of the
     ...
     * functions below will call <code>Recognize</code> if needed. After Recognize, 
     ...
     * delete [] operator.
     * 
     * @deprecated We don't need this in a production system
     */
    ...
    public static class TessResultIterator extends TessPageIterator {
